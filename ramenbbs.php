...
<html>
	...
	<body>
		...
		<form method = "post">
			...
			<input type = "text" name = "name" value = "<?php if(!empty($Ename)){ echo $Ename; } ?>" placeholder="お名前"><br>
			<input type = "text" name = "comment" value = "<?php if(!empty($Ecomment)){ echo $Ecomment; } ?>" placeholder = "お好きなラーメン"><br>
...
//削除機能
	...
	foreach($results as $row){
		echo $row['id']."  ";
		echo $row['name']."さんの好きなラーメンは";
		echo $row['comment']."だってよ。".'<br>';
	echo "<hr>";
	}
